...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='DopeMAN WebSocket Server')
    parser.add_argument('--port', type=int, default=8892, help='WebSocket 端口 (預設: 8892)')
